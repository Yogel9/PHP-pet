...
<header class="p-3 bg-dark text-white">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-success text-decoration-none">
          MyWeb
        </a>
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="/" class="nav-link px-2 text-white">Главная</a></li>
           ...
           <?php else: ?>
            <li><a href="/todoList.php" class="nav-link px-2 text-muted disabled" role="button" aria-disabled="true" >Список дел</a></li>
            <?php endif; ?>
        ...
        <?php if (isset($_COOKIE['user'])): ?>
            <div class="text-end">
          <a class="btn btn-outline-light me-2" href="validation-form/cookie_del.php"><?php echo $_COOKIE['user']; ?></a>
            </div>
        <?php else: ?>
            <div class="text-end">
